...
return array(
	...
	'columns' => array(
		...
		'icon' => array(
			'exclude' => 0,
			'label'   => $nj_collection_lang_file.'general.label.icon',			
			'config'  => array(
				'type' => 'text',
				'cols' => 60,
				'rows' => 6
		...
		'icon_include' => array(
            'exclude' => 0,
            'label'   => $nj_collection_lang_file.'general.label.iconInclude',
            'config'  => array(
                'type' => 'check'
            )
        ),
		...
		'title' => array(
			'exclude' => 0,
			'label'   => $nj_collection_lang_file.'general.label.title',			
			'config'  => array(
				'type' => 'input',
				'size' => 40,
				'eval' => 'trim,unique',
		...
		'description' => array(
			'exclude' => 1,
			'label'   => $nj_collection_lang_file.'general.label.description',
	...
	'types' => array(
		'0' => array('showitem' => 'title, description, icon_include, icon'	)
	),
	'palettes' => array(
